# Getting help with bciex

Thanks for using bciex. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to search _issues_ and _pull requests_ in the relavant package ([here is the list of all __bciex__ packages](https://github.com/forestgeo/bciex/issues)) to make sure the bug 
